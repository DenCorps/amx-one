...
use mp_api::{ExecutionContext, ProofRecorder, StorageTransactionCache};
...
pub trait CallExecutor<B: BlockT>: RuntimeVersionOf {
    ...
    fn call(
        ...
        context: CallContext,
    ) -> Result<Vec<u8>, mp_blockchain::Error>;
    ...
    ) -> mp_blockchain::Result<Vec<u8>>;

    /// Extract RuntimeVersion of given block
    ///
    /// No changes are made.
    fn runtime_version(&self, at_hash: B::Hash) -> Result<RuntimeVersion, mp_blockchain::Error>;
    ...
    fn prove_execution(
        ...
        method: &str,
        call_data: &[u8],
    ) -> Result<(Vec<u8>, StorageProof), mp_blockchain::Error>;
}
