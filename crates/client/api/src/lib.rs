...
pub use client::*;
pub use mp_blockchain as blockchain;
pub use mp_blockchain::HeaderBackend;
...
pub trait UsageProvider<Block: mp_runtime::traits::Block> {
...
pub mod utils {
    ...
    use mp_blockchain::{Error, HeaderBackend, HeaderMetadata};
        ...
        T: HeaderBackend<Block> + HeaderMetadata<Block, Error = Error>,
    {
        move |base, hash| {
            ...
            let ancestor = mp_blockchain::lowest_common_ancestor(client, *hash, *base)?;
