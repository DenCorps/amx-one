...
pub trait ProofProvider<Block: BlockT> {
    ...
    ) -> mp_blockchain::Result<StorageProof>;
    ...
    fn execution_proof(
        ...
        method: &str,
        call_data: &[u8],
    ) -> mp_blockchain::Result<(Vec<u8>, StorageProof)>;
    ...
    fn read_proof_collection(
        ...
        start_keys: &[Vec<u8>],
        size_limit: usize,
    ) -> mp_blockchain::Result<(CompactProof, u32)>;
    ...
    fn storage_collection(
        ...
        start_key: &[Vec<u8>],
        size_limit: usize,
    ) -> mp_blockchain::Result<Vec<(KeyValueStorageLevel, bool)>>;
    ...
    fn verify_range_proof(
        ...
        proof: CompactProof,
        start_keys: &[Vec<u8>],
    ) -> mp_blockchain::Result<(KeyValueStates, usize)>;
}
