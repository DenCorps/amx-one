            ...
            fn metadata_ir() -> #scrate::metadata_ir::MetadataIR {
                ...
                #scrate::metadata_ir::MetadataIR {
                    ...
                    extrinsic: #scrate::metadata_ir::ExtrinsicMetadataIR {
                        ...
                        version: <#extrinsic as #scrate::mp_runtime::traits::ExtrinsicMetadata>::VERSION,
                        signed_extensions: <
                                <
                                    #extrinsic as #scrate::mp_runtime::traits::ExtrinsicMetadata
                                >::SignedExtensions as #scrate::mp_runtime::traits::SignedExtension
                            >::metadata()
                                .into_iter()
...
fn expand_pallet_metadata_storage(filtered_names: &[&'static str], runtime: &Ident, decl: &Pallet) -> TokenStream {
...
fn expand_pallet_metadata_calls(filtered_names: &[&'static str], runtime: &Ident, decl: &Pallet) -> TokenStream {
...
fn expand_pallet_metadata_events(
    ...
    if filtered_names.contains(&"Event") {
        let path = &decl.path;
        let part_is_generic = !decl.find_part("Event").expect("Event part exists; qed").generics.params.is_empty();
