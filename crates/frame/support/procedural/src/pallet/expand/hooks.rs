...
pub fn expand_hooks(def: &mut Def) -> proc_macro2::TokenStream {
    ...
    quote::quote_spanned!(span =>
            ...
            for #pallet_ident<#type_use_gen> #where_clause
        {
            ...
            fn pre_upgrade() -> Result< #frame_support::sp_std::vec::Vec<u8>, #frame_support::mp_runtime::TryRuntimeError> {
                <
                    Self
                    as
                    #frame_support::traits::Hooks<<T as #frame_system::Config>::BlockNumber>
            ...
            #[cfg(feature = "try-runtime")]
            fn post_upgrade(state: #frame_support::sp_std::vec::Vec<u8>) -> Result<(), #frame_support::mp_runtime::TryRuntimeError> {
            ...
            for #pallet_ident<#type_use_gen> #where_clause
        {
            ...
            ) -> Result<(), #frame_support::mp_runtime::TryRuntimeError> {
                #log_try_state
                <
                    Self as #frame_support::traits::Hooks<
                        <T as #frame_system::Config>::BlockNumber
