...
impl CompositeDef {
    pub fn try_from(
        ...
        let item = if let syn::Item::Enum(item) = item {
            ...
            return Err(syn::Error::new(item.span(), "Invalid pallet::composite_enum, expected enum item"));
        };
        ...
        let composite_keyword = syn::parse2::<keyword::CompositeKeyword>(item.ident.to_token_stream())?;
