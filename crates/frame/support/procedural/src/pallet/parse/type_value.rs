...
impl TypeValueDef {
    pub fn try_from(attr_span: proc_macro2::Span, index: usize, item: &mut syn::Item) -> syn::Result<Self> {
        ...
        for attr in &item.attrs {
            ...
            let msg = "Invalid pallet::type_value, unexpected attribute, only doc attribute are allowed";
        ...
        Ok(TypeValueDef { attr_span, index, is_generic, vis, ident, block, type_, instances, where_clause, docs })
    }
}
