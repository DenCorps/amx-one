...
use super::instance_trait::INHERENT_INSTANCE_NAME;
...
fn from_optional_value_to_query(is_option: bool, default: &Option<syn::Expr>) -> TokenStream {
    let default = default.as_ref().map(|d| quote!( #d )).unwrap_or_else(|| quote!(Default::default()));
                ...
                StorageLineTypeDef::Simple(_) => {
                    quote!(
                        ...
                        #optional_storage_where_clause
                        {
                            ...
                            {
                                use #scrate::mp_runtime::SaturatedConversion;
