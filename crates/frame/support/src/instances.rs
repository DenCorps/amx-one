...
//!
//! [`frame_support::pallet`] attribute macro does only requires the instance generic `I` to
...
//! ```
//!
//! NOTE: [`frame_support::pallet`] will reexport them inside the module, in order to make
//! them accessible to [`frame_support::construct_runtime`].

/// `Instance1` to be used for instantiable palllets defined with the
/// [`#[pallet]`](`frame_support::pallet`) macro. Instances 2-16 are also available but are
/// hidden from docs.
