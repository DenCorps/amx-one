...
impl<K: ReversibleKeyGenerator, V: FullCodec, G: StorageNMap<K, V>> storage::IterableStorageNMap<K, V> for G {
    ...
    {
        let prefix = G::storage_n_map_partial_key(kp);
        KeyPrefixIterator { prefix: prefix.clone(), previous_key: prefix, drain: false, closure: K::decode_partial_key }
    }
...
mod test_iterators {
    ...
    fn n_map_iter_from() {
        sp_io::TestExternalities::default().execute_with(|| {
            ...
            #[crate::storage_alias]
            type MyNMap =
                StorageNMap<MyModule, (NMapKey<Identity, u64>, NMapKey<Identity, u64>, NMapKey<Identity, u64>), u64>;
    ...
    fn n_map_reversible_reversible_iteration() {
        sp_io::TestExternalities::default().execute_with(|| {
            ...
            assert_eq!(NMap::iter().collect::<Vec<_>>(), vec![((3, 3), 3), ((0, 0), 0), ((2, 2), 2), ((1, 1), 1)],);

            assert_eq!(NMap::iter_keys().collect::<Vec<_>>(), vec![(3, 3), (0, 0), (2, 2), (1, 1)]);

            assert_eq!(NMap::iter_values().collect::<Vec<_>>(), vec![3, 0, 2, 1]);

            assert_eq!(NMap::drain().collect::<Vec<_>>(), vec![((3, 3), 3), ((0, 0), 0), ((2, 2), 2), ((1, 1), 1)],);
            ...
            assert_eq!(NMap::iter_prefix((k1,)).collect::<Vec<_>>(), vec![(1, 1), (2, 2), (0, 0), (3, 3)],);
            ...
            assert_eq!(NMap::drain_prefix((k1,)).collect::<Vec<_>>(), vec![(1, 1), (2, 2), (0, 0), (3, 3)],);
            ...
            assert_eq!(NMap::iter().collect::<Vec<_>>(), vec![((3, 3), 6), ((0, 0), 0), ((2, 2), 4), ((1, 1), 2)],);
        })
    }
}
