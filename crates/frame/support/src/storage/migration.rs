...
use crate::storage::{storage_prefix, unhashed};
...
/// # })
/// ```
pub fn move_storage_from_pallet(storage_name: &[u8], old_pallet_name: &[u8], new_pallet_name: &[u8]) {
...
mod tests {
    ...
    use super::{move_pallet, move_prefix, move_storage_from_pallet, storage_iter, storage_key_iter};
    use crate::hash::StorageHasher;
    use crate::pallet_prelude::{StorageMap, StorageValue, Twox128, Twox64Concat};
