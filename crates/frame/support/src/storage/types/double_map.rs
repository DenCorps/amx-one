...
use crate::storage::types::{OptionQuery, QueryKindTrait, StorageEntryMetadataBuilder};
use crate::storage::{KeyLenOf, StorageAppend, StorageDecodeLength, StoragePrefixedMap, StorageTryAppend};
...
impl<Prefix, Hasher1, Key1, Hasher2, Key2, Value, QueryKind, OnEmpty, MaxValues> Get<u32>
    for KeyLenOf<StorageDoubleMap<Prefix, Hasher1, Key1, Hasher2, Key2, Value, QueryKind, OnEmpty, MaxValues>>
where
    ...
    Key2: MaxEncodedLen,
{
    fn get() -> u32 {
        ...
        let z = Hasher1::max_len::<Key1>() + Hasher2::max_len::<Key2>() + Twox128::max_len::<()>() * 2;
        z as u32
    }
}
...
impl<Prefix, Hasher1, Key1, Hasher2, Key2, Value, QueryKind, OnEmpty, MaxValues> StoragePrefixedMap<Value>
    for StorageDoubleMap<Prefix, Hasher1, Key1, Hasher2, Key2, Value, QueryKind, OnEmpty, MaxValues>
where
    Prefix: StorageInstance,
    Hasher1: crate::hash::StorageHasher,
    ...
    MaxValues: Get<Option<u32>>,
{
    ...
    pub fn clear_prefix<KArg1>(first_key: KArg1, limit: u32, maybe_cursor: Option<&[u8]>) -> sp_io::MultiRemovalResults
    where
        KArg1: ?Sized + EncodeLike<Key1>,
    {
    ...
    >(
        ...
        <Self as crate::storage::StorageDoubleMap<Key1, Key2, Value>>::migrate_keys::<OldHasher1, OldHasher2, _, _>(
            key1, key2,
        )
    }
    ...
    {
        <Self as crate::storage::TryAppendDoubleMap<Key1, Key2, Value, Item>>::try_append(key1, key2, item)
    }
}
    ...
    MaxValues: Get<Option<u32>>,
{
    ...
    pub fn iter_prefix_from(
        ...
        <Self as crate::storage::IterableStorageDoubleMap<Key1, Key2, Value>>::iter_prefix_from(k1, starting_raw_key)
    }
    ...
    ///
    /// If you add or remove values to the map while doing this, you'll get undefined results.
    pub fn iter_from(starting_raw_key: Vec<u8>) -> crate::storage::PrefixIterator<(Key1, Key2, Value)> {
        <Self as crate::storage::IterableStorageDoubleMap<Key1, Key2, Value>>::iter_from(starting_raw_key)
    }
    ...
    pub fn iter_keys_from(starting_raw_key: Vec<u8>) -> crate::storage::KeyPrefixIterator<(Key1, Key2)> {
        <Self as crate::storage::IterableStorageDoubleMap<Key1, Key2, Value>>::iter_keys_from(starting_raw_key)
    }
...
impl<Prefix, Hasher1, Hasher2, Key1, Key2, Value, QueryKind, OnEmpty, MaxValues> StorageEntryMetadataBuilder
    for StorageDoubleMap<Prefix, Hasher1, Key1, Hasher2, Key2, Value, QueryKind, OnEmpty, MaxValues>
where
    Prefix: StorageInstance,
    Hasher1: crate::hash::StorageHasher,
...
impl<Prefix, Hasher1, Hasher2, Key1, Key2, Value, QueryKind, OnEmpty, MaxValues> crate::traits::StorageInfoTrait
    for StorageDoubleMap<Prefix, Hasher1, Key1, Hasher2, Key2, Value, QueryKind, OnEmpty, MaxValues>
where
    Prefix: StorageInstance,
    Hasher1: crate::hash::StorageHasher,
...
impl<Prefix, Hasher1, Hasher2, Key1, Key2, Value, QueryKind, OnEmpty, MaxValues> crate::traits::PartialStorageInfoTrait
    for StorageDoubleMap<Prefix, Hasher1, Key1, Hasher2, Key2, Value, QueryKind, OnEmpty, MaxValues>
where
    Prefix: StorageInstance,
    Hasher1: crate::hash::StorageHasher,
...
mod test {
    ...
    use super::*;
    use crate::hash::*;
    use crate::metadata_ir::{StorageEntryModifierIR, StorageEntryTypeIR, StorageHasherIR};
    ...
    fn test() {
        ...
        type AValueQueryWithAnOnEmpty =
            StorageDoubleMap<Prefix, Blake2_128Concat, u16, Twox64Concat, u8, u32, ValueQuery, ADefault>;
