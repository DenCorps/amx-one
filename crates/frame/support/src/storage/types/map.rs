...
pub struct StorageMap<Prefix, Hasher, Key, Value, QueryKind = OptionQuery, OnEmpty = GetDefault, MaxValues = GetDefault>(
...
impl<Prefix, Hasher, Key, Value, QueryKind, OnEmpty, MaxValues> crate::storage::generator::StorageMap<Key, Value>
    ...
    MaxValues: Get<Option<u32>>,
{
    fn storage_info() -> Vec<StorageInfo> {
        vec![StorageInfo {
            ...
            max_size: Some(Hasher::max_len::<Key>().saturating_add(Value::max_encoded_len()).saturated_into()),
        }]
    }
}
...
mod test {
    ...
    fn test() {
        ...
        type AValueQueryWithAnOnEmpty = StorageMap<Prefix, Blake2_128Concat, u16, u32, ValueQuery, ADefault>;
