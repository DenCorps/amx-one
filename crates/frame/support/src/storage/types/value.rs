...
use crate::storage::generator::StorageValue as StorageValueT;
...
use crate::traits::{GetDefault, StorageInfo, StorageInstance};
    ...
    OnEmpty: crate::traits::Get<QueryKind::Query> + 'static,
{
    ...
    pub fn try_mutate_exists<R, E, F: FnOnce(&mut Option<Value>) -> Result<R, E>>(f: F) -> Result<R, E> {
...
mod test {
    ...
    use super::*;
    use crate::metadata_ir::StorageEntryModifierIR;
