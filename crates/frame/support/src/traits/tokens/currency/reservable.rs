...
use crate::traits::{ExistenceRequirement, SignedImbalance, WithdrawReasons};
...
pub struct WithName<NamedReservable, Id, AccountId>(sp_std::marker::PhantomData<(NamedReservable, Id, AccountId)>);
impl<NamedReservable: NamedReservableCurrency<AccountId>, Id: Get<NamedReservable::ReserveIdentifier>, AccountId>
