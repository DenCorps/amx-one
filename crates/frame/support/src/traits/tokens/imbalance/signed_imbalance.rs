...
use codec::FullCodec;
use mp_runtime::traits::{AtLeast32BitUnsigned, MaybeSerializeDeserialize};
...
> SignedImbalance<B, P>
{
    ...
    pub fn merge(self, other: Self) -> Self {
        match (self, other) {
            ...
            (SignedImbalance::Positive(one), SignedImbalance::Negative(other)) => match one.offset(other) {
