...
use mp_runtime::traits::Convert;
use mp_runtime::{ArithmeticError, DispatchError, TokenError};
...
pub trait AssetId: FullCodec + Clone + Eq + PartialEq + Debug + scale_info::TypeInfo + MaxEncodedLen {}
impl<T: FullCodec + Clone + Eq + PartialEq + Debug + scale_info::TypeInfo + MaxEncodedLen> AssetId for T {}
