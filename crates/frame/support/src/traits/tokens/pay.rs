...
use super::Preservation::Expendable;
...
pub trait Pay {
    ...
    fn pay(who: &Self::Beneficiary, asset_kind: Self::AssetKind, amount: Self::Balance) -> Result<Self::Id, ()>;
...
impl<A: TypedGet, F: fungible::Mutate<A::Type>> Pay for PayFromAccount<F, A> {
    ...
    type AssetKind = ();
    type Id = ();
    fn pay(who: &Self::Beneficiary, _: Self::AssetKind, amount: Self::Balance) -> Result<Self::Id, ()> {
