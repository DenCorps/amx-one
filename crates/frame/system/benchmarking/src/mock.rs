...
use codec::Encode;
use mp_runtime::traits::IdentityLookup;
...
impl frame_system::Config for Test {
    ...
    type Hashing = ::mp_runtime::traits::BlakeTwo256;
    type AccountId = AccountId;
    type Lookup = IdentityLookup<Self::AccountId>;
    type Header = mp_runtime::testing::Header;
...
pub fn new_test_ext() -> sp_io::TestExternalities {
    ...
    let version = mp_version::RuntimeVersion {
