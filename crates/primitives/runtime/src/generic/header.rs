...
pub struct Header<Number: Copy + Into<U256> + TryFrom<U256>, Hash: HashT> {
    ...
    /// The block number.
    #[cfg_attr(feature = "serde", serde(serialize_with = "serialize_number", deserialize_with = "deserialize_number"))]
    #[codec(compact)]
    pub number: Number,
...
mod tests {
    ...
    fn ensure_format_is_unchanged() {
        let header = Header::<u32, BlakeTwo256> {
            ...
            digest: crate::generic::Digest { logs: vec![crate::generic::DigestItem::Other(b"6".to_vec())] },
        };
        ...
        assert_eq!(
            header_encoded,
            vec![
                146, 205, 245, 120, 196, 112, 133, 165, 153, 34, 86, 240, 220, 249, 125, 11, 25, 241, 241, 201, 222,
                77, 95, 227, 12, 58, 206, 97, 145, 182, 229, 219, 8, 88, 19, 72, 51, 123, 15, 62, 20, 134, 32, 23, 61,
                170, 165, 249, 77, 0, 216, 129, 112, 93, 203, 240, 170, 131, 239, 218, 186, 97, 210, 237, 225, 235,
                134, 73, 33, 73, 151, 87, 78, 32, 196, 100, 56, 138, 23, 36, 32, 210, 84, 3, 104, 43, 187, 184, 12, 73,
        ...
        let header = Header::<u32, BlakeTwo256> {
            ...
            digest: crate::generic::Digest { logs: vec![crate::generic::DigestItem::Other(b"5000".to_vec())] },
        };
        ...
        assert_eq!(
            header_encoded,
            vec![
                197, 243, 254, 225, 31, 117, 21, 218, 179, 213, 92, 6, 247, 164, 230, 25, 47, 166, 140, 117, 142, 159,
                195, 202, 67, 196, 238, 26, 44, 18, 33, 92, 65, 31, 219, 225, 47, 12, 107, 88, 153, 146, 55, 21, 226,
                186, 110, 48, 167, 187, 67, 183, 228, 232, 118, 136, 30, 254, 11, 87, 48, 112, 7, 97, 31, 82, 146, 110,
                96, 87, 152, 68, 98, 162, 227, 222, 78, 14, 244, 194, 120, 154, 112, 97, 222, 144, 174, 101, 220, 44,
